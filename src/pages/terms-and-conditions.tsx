  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-8 sm:px-8 sm:py-12 lg:py-16 xl:px-0">
      ...
      <div className="grid grid-cols-12 gap-8 lg:gap-12">
        <div className="order-2 col-span-12 text-base md:order-1 md:col-span-8">
          <div className="mb-10 mt-0 space-y-4 md:mt-10">
            <p>
              We are a company registered in Indonesia at Jl. Tipar cakung Kav.
              F 5-7, Jakarta, DKI jakarta 13910.
            </p>
            <p>
              ...
              link to these legal terms. You can contact us by email at{' '}
              <a
                className="text-blue underline"
                href="mailto:dev.mysoklin@gmail.com"
              >
                dev.mysoklin@gmail.com
              </a>{' '}
              or by mail to Jl. Tipar cakung Kav. F 5-7, Jakarta, DKI jakarta
              13910, Indonesia.
            </p>
            <p>
          ...
          <div className="mb-10 space-y-4">
            <h3 className="text-2xl font-bold">1. Our Services</h3>
            <p>
          ...
          <div className="mb-10 space-y-4">
            ...
            <h6 className="font-bold">Your use of our Services</h6>
            <p>
          ...
          <div className="mb-10 space-y-4">
            <h3 className="text-2xl font-bold">3. User Representations</h3>
            <p>
          ...
          <div className="mb-10 space-y-4">
            <h3 className="text-2xl font-bold">4. User Registration</h3>
            <p>
          ...
          <div className="mb-10 space-y-4">
            <h3 className="text-2xl font-bold">5. Prohibited Activities</h3>
            <p>
          ...
          <div className="mb-10 space-y-4">
            <h3 className="text-2xl font-bold">7. Contribution License</h3>
            <p>
          ...
          <div className="mb-10 space-y-4">
            <h3 className="text-2xl font-bold">8. Services Management</h3>
            <p>
          ...
          <div className="mb-10 space-y-4">
            <h3 className="text-2xl font-bold">9. Privacy Policy</h3>
            <p>
              ...
              advised the Services are hosted in Indonesia. If you access the
              Services from any other region of the world with laws or other
              requirements governing personal data collection, use, or
              disclosure that differ from applicable laws in Indonesia, then
              through your continued use of the Services, you are transferring
              your data to Indonesia, and you expressly consent to have your
              data transferred to and processed in Indonesia.
            </p>
          </div>
          <div className="mb-10 space-y-4">
            <h3 className="text-2xl font-bold">10. Term and Termination</h3>
            <p>
          ...
          <div className="mb-10 space-y-4">
            <h3 className="text-2xl font-bold">12. Governing Law</h3>
            <p>
          ...
          <div className="mb-10 space-y-4">
            <h3 className="text-2xl font-bold">13. Despute Resolution</h3>
          ...
          <div className="mb-10 space-y-4">
            <h3 className="text-2xl font-bold">14. Corrections</h3>
            <p>
          ...
          <div className="mb-10 space-y-4">
            <h3 className="text-2xl font-bold">15. Disclaimer</h3>
            <p>
          ...
          <div className="mb-10 space-y-4">
            <h3 className="text-2xl font-bold">16. Limitations of Liability</h3>
            <p>
          ...
          <div className="mb-10 space-y-4">
            <h3 className="text-2xl font-bold">18. User Data</h3>
            <p>
          ...
          <div className="mb-10 space-y-4">
            <h3 className="text-2xl font-bold">20. Miscellaneous</h3>
            <p>
          ...
          <div className="mb-10 space-y-4">
            ...
            <div>
              <h6 className="font-bold">Jl. Tipar cakung Kav. F 5-7</h6>
              <h6 className="font-bold">Jakarta, DKI jakarta 13910</h6>
              <h6 className="font-bold">Indonesia</h6>
            </div>
          </div>
        </div>
